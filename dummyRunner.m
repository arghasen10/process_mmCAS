function main()
    ...
    [radar_data_Rxchain_master] = readBinFile("C:\ti\mmwave_studio_02_01_01_00\mmWaveStudio\PostProc\cascade_cpu_head_1\master_0000_data.bin", frameIdx,256,12,64,4,1);
    [radar_data_Rxchain_slave1] = readBinFile("C:\ti\mmwave_studio_02_01_01_00\mmWaveStudio\PostProc\cascade_cpu_head_1\slave1_0000_data.bin", frameIdx,256,12,64,4,1);
    [radar_data_Rxchain_slave2] = readBinFile("C:\ti\mmwave_studio_02_01_01_00\mmWaveStudio\PostProc\cascade_cpu_head_1\slave2_0000_data.bin", frameIdx,256,12,64,4,1);
    [radar_data_Rxchain_slave3] = readBinFile("C:\ti\mmwave_studio_02_01_01_00\mmWaveStudio\PostProc\cascade_cpu_head_1\slave3_0000_data.bin", frameIdx,256,12,64,4,1);
